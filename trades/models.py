...
class Trades(models.Model):
    ...
    sell_currency = models.ForeignKey(to='trades.Currencies', verbose_name=_('Sell Currency'), related_name='sell_currency')
    sell_amount = models.DecimalField(verbose_name=_('Sell Amount'), max_digits=100, decimal_places=2)
    buy_currency = models.ForeignKey(to='trades.Currencies', verbose_name=_('Buy Currency'), related_name='buy_currency')
